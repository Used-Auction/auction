...
import com.example.auction.Global.filter.JwtAuthFilter;
...
public class WebConfig{
     ...
     * 화이트 리스트.
     */
    private static final String[] WHITE_LIST = {"/accounts/login", "/accounts/join", "/users/join", "/users/login", "/favicon.ico", "/auth/kakao/*",
            "/error"};
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:3000")); // 허용 origin
